...
if [ ! -f "/var/www/html/index.html" ]; then
	...
	wp config create --allow-root --dbname=$MARIADB_DB_NAME --dbuser=$MARIADB_USER_NAME --dbpass=$MARIADB_USER_PWD --dbhost='mariadb:3306' --dbcharset="utf8" --dbcollate="utf8_general_ci" 
